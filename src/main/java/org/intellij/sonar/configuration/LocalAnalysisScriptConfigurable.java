...
public class LocalAnalysisScriptConfigurable extends DialogWrapper {
  ...
  private JLabel labelForPathToReport;
  private TextFieldWithBrowseButton myPathToReportTextFieldWithBrowseButton;
  ...
  protected JComponent createCenterPanel() {
    ...
    labelForPathToReport.setIcon(AllIcons.Actions.Help);
    labelForPathToReport.setHorizontalTextPosition(JLabel.LEFT);
    labelForPathToReport.addMouseListener(SHOW_HOW_TO_DEFINE_SOURCE_CODE_OF_INCREMENTAL_ANALYSIS_SCRIPT);
    myPathToReportTextFieldWithBrowseButton.addActionListener(new ExternalEditorPathActionListener());
    return myRootPanel;
  }
  ...
  public LocalAnalysisScript toLocalAnalysisScript() {
    return LocalAnalysisScript.of(
        ...
        myPathToReportTextFieldWithBrowseButton.getText().trim()
    );
  }
  ...
  public void setValuesFrom(LocalAnalysisScript s) {
    ...
    myPathToReportTextFieldWithBrowseButton.setText(Strings.nullToEmpty(s.getPathToSonarReport()).trim());
  }
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      VirtualFile previous = application.runWriteAction(
          (NullableComputable<VirtualFile>) () -> {
            final String path = FileUtil.toSystemIndependentName(myPathToReportTextFieldWithBrowseButton.getText
                ());
      ...
      FileChooser.chooseFiles(
          ...
          files -> {
            ...
            myPathToReportTextFieldWithBrowseButton.setText(path);
          }
      );
    }
  }
